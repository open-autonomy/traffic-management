...
| `"WayId"` | WayId | Integer | True | The Way ID identifying the road segment (way) that the AV intends to use to enter the zone. (see ISO23725) If the vehicle is inside the target zone this field should be `null`.  |
